    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            <img class="size-8" src="https://avatars.githubusercontent.com/u/100887685?v=4&size=64" alt="Your Company" />
          </div>
            ...
            <div class="relative ml-3">
              <div>
                <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  ...
                  <img class="size-8 rounded-full" src="https://avatars.githubusercontent.com/u/100887685?v=4&size=64" alt="" />
                </button>
              </div>
            </div>
          </div>
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img class="size-10 rounded-full" src="https://avatars.githubusercontent.com/u/100887685?v=4&size=64" alt="" />
          </div>
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Aryan Shrestha</div>
            <div class="text-sm font-medium text-gray-400">aryanshrestha0981.com</div>
          </div>
